...
// 클래스.스태틱메소드 인 경우, 임포트할 때 static 키워드를 사용하면 작성하는 클래스 내에서
// 클래스명은 생략하고 바로 스태틱메소드를 사용할 수 있다.
...
// 테스트를 위한 포트를 누가 쓰고있다면 다른 포트를 쓰겠다.
...
public class EmpDaoImplTest {
	...
	public void testInsert() {
		...
		System.out.println("후: " + emp); // empno 값은 디비가 자동으로 제너레이트한 값
	...
	public void testUpdate() {
		...
		System.out.println("지웠음 : " + affected);
	}
